...
1. Authentication is handled exclusively by an external Authentik SSO instance (initially `auth.nextuon.com`, but fully configurable for any Authentik deployment).
...
```
AUTHENTIK_ISSUER=https://auth.nextuon.com/application/o/retroassembly/
AUTHENTIK_CLIENT_ID=...
